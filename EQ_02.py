...
FAMA_FRENCH_3 = pd.read_csv("F-F_Research_Data_Factors_daily.csv",names=['Mkt-RF','SMB','HML','RF'], skiprows=24516, nrows=44)
...
PORTFOLIO = portfolio_return(Stock_Symbols, '2019-06-28', '2019-08-31')
